...
app.post('/api/create', (req,res) => {
    ...
    const film = new Film(undefined, req.body.title, req.body.isFavorite, dayjs(req.body.date), req.body.score);
...
app.put('/api/update/:filmId', (req,res) => {
    ...
    dao.updateFilm(req.params.filmId, req.body.title, req.body.isFavorite, dayjs(req.body.date), req.body.score).then((result) => {
        res.end();
    }).catch((error) => {
        res.status(500).send(error);
    })

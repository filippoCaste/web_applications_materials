...
function EditFilm(props) {
    ...
    const editFilmHere = async (event) => {
        ...
        if (title != '') {
            ...
            await editFilm(filmId, title, favorite, date, score);
        } else {
        ...
        <div>
            <Form noValidate validated={validated}>
                ...
                <Form.Group controlId="button">
                    ...
                    <Button variant='success' id="saveButton" onClick={editFilmHere}>SAVE</Button>
